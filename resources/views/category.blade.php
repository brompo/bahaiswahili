		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 text-center">
					<h1 id="fh5co-logo"><a href="index.html">{{$category->title}}</a></h1>
				</div>
...
@foreach ($category->resources as $resource)
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="/categories/resources/{{$resource->id}}"><img src="images/pic_1.jpg" alt="Image" class="img-responsive"></a>
				</figure>
